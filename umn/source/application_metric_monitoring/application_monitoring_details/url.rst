...
#. In the tree on the left, click |image2| next to the target environment. On the **URL** tab page that is displayed, view URL monitoring information of all instances.
...
.. |image2| image:: /_static/images/en-us_image_0000001278181621.png
