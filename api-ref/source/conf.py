...
otcdocs_repo_name = 'opentelekomcloud-docs/application-performance-management'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/application-performance-management/api-ref/'
...
html_title = "Application Performance Management - API Reference"
...
latex_documents = [
    ('index',
     'apm-api-ref.tex',
    u'Application Performance Management - API Reference',
